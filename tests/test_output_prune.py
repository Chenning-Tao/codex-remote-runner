...
from remote_runner._internal.controller.registry import ControllerPaths, controller_paths
...
def test_prune_outputs_is_dry_run_then_records_verified_deletion(
    ...
    monkeypatch.setattr(
        ...
        "prune_remote_output",
        lambda **kwargs: calls.append(str(kwargs["output_path"]))
    ...
    assert completed[0]["receipt"]["source_deletion_result"]["action"] == "removed_directory"
